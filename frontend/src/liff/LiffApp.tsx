...
import PatientFormsFlow from './patient_form/PatientFormsFlow';

type AppMode = 'home' | 'book' | 'query' | 'settings' | 'notifications' | 'reschedule' | 'forms';
const VALID_MODES: AppMode[] = ['home', 'book', 'query', 'settings', 'notifications', 'reschedule', 'forms'];
