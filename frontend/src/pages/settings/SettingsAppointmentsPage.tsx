...
import { LoadingSpinner, BaseModal, ActionableCard } from '../../components/shared';
                                    ...
                                    return (
                                        <ActionableCard
                                            ...
                                            actions={[
                                                {
                                                    ...
                                                    onClick: async (e) => {
                                                        ...
                                                        try {
                                                            ...
                                                            alert(`${modeInfo.name}連結已複製到剪貼簿！`, '成功');
                                                        } catch (err) {
                                            ...
                                            metadata={[
                                                {
                                                    label: (
                                                        <code className="text-[10px] md:text-xs font-mono bg-gray-100 px-2 py-0.5 rounded break-all">
                                                            {url}
                                                        </code>
                                                    )
                                                }
